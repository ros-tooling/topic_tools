...
#include "topic_tools/srv/mux_add.hpp"
#include "topic_tools/srv/mux_delete.hpp"
#include "topic_tools/srv/mux_list.hpp"
#include "topic_tools/srv/mux_select.hpp"
...
private:
  ...
  void on_mux_list(
    const std::shared_ptr<topic_tools::srv::MuxList::Request> request,
  ...
  rclcpp::Service<topic_tools::srv::MuxAdd>::SharedPtr mux_add_srv_;
  rclcpp::Service<topic_tools::srv::MuxDelete>::SharedPtr mux_delete_srv_;
  rclcpp::Service<topic_tools::srv::MuxList>::SharedPtr mux_list_srv_;
  rclcpp::Service<topic_tools::srv::MuxSelect>::SharedPtr mux_select_srv_;
};
}  // namespace topic_tools
